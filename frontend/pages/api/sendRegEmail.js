...
export default async (req, res) => {
  ...
  await transporter
    .sendMail({
      ...
      text: `To Ensure that the registration has not been done by a ROBOT, we issue a token and send it to the user to confirm this. The website won't allow you to see contents when you are signed in unless and until you confirm your account.Here is your confirmation code: ${token} Thank you ! Best Regards,The Tech To Rehab Team`,
      html: `
